...
var Icon$1I = function (props) {
    return (React.createElement("img", __assign({}, props, { src: "/cfx.png" })));    
};
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#3bbfe7", background: "#141f2e", backgroundDisabled: "#3c3742", backgroundAlt: "#020316", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#439f5d", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#B8ADD2", disabled: "#524B63", gradients: {
        bubblegum: "linear-gradient(139.73deg, #141f2e 0%, #141f2e 100%)",
        inverseBubblegum: "linear-gradient(139.73deg, #141f2e 0%, #141f2e 100%)",
        cardHeader: "linear-gradient(166.77deg, #3B4155 0%, #3A3045 100%)",
        blue: "linear-gradient(180deg, #4e0303 0%, #EAA7E5 100%)",
...
var links = [
    ...
    },
    {
        ...
        items: [
            {
                label: "Exchange",
                href: "https://nitfeeswap.xyz",
            },
            {
                label: "Liquidity",
                href: "https://nitfeeswap.xyz/#/pool",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        items: [
            {
                label: "Overview",
                href: "https://NitfeeDex.info",
            },
            {
                label: "Tokens",
                href: "https://NitfeeDex.info/tokens",
            },
            {
                label: "Pairs",
                href: "https://NitfeeDex.info/pairs",
            },
            {
                label: "Accounts",
                href: "https://NitfeeDex.info/accounts",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        items: [
            {
                label: "Voting",
                href: "https://voting.nitfeeswap.xyz",
            },
            {
                label: "Github",
                href: "https://github.com/NitfeeDex",
            },
            {
                label: "Docs",
                href: "https://docs.nitfeeswap.xyz",
            },
            {
                label: "Blog",
                href: "https://NitfeeDex.medium.com",
            },
        ],
    },
];
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/NitfeeMarket",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/nitfeemarketCFX",
    },
];
var MENU_HEIGHT = 64;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://nitfeeswap.xyz/swap?outputCurrency=0x1cbF4cCDEfb2b880933f413D7D9B45Af7cdfBA9e", target: "_blank" },
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://evm.confluxscan.io/address/" + account, mr: "16px" }, "View on ConfluxScan"),
